...
def pneumonia_pred():
    ...
    root.title('PNEUMONIA DISEASE PREDICTION')
    ...
    draw.text((450, 20), "Pneumonia Disease Recognition", font=font, fill="#BBFFFF")
    ...
    def pred():
        ...
        prediction = get3.predict(file_path)
        print(prediction)
        ...
        if prediction==0:
            ...
            result = ctk.CTkLabel(root,text='P n e u m o n i a   I n f e c t e d',
